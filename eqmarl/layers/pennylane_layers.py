...
class OLD_HybridVariationalEncodingPQC(keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        qnode = qml.QNode(func=self.circuit, device=device, interface='tf')
    ...
    def generate_circuit(*args, **kwargs):
        return circuits.OLD_VariationalEncodingCircuit(*args, **kwargs)
