...
series=[
    ...
    dict(
        key='$\Phi^{+}$',
        blob='../experiment_output/cartpole_maa2c_pomdp_eqmarl_phi+/*/metrics-[0-9].json',
    ...
    dict(
        key='$\mathtt{None}$',
        blob='../experiment_output/cartpole_maa2c_pomdp_eqmarl_noentanglement/*/metrics-[0-9].json',
