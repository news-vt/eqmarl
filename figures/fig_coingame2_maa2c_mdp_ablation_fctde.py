...
series=[
    dict(
        key='$\\mathtt{fCTDE}$-3',
        blob='../experiment_output/coingame_maa2c_mdp_fctde_size3/20240803T133747/metrics-[0-9].json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{fCTDE}$-6',
        blob='../experiment_output/coingame_maa2c_mdp_fctde_size6/20240802T225024/metrics-[0-9].json',
    ...
    dict(
        key='$\\mathtt{fCTDE}$-24',
        blob='../experiment_output/coingame_maa2c_mdp_fctde_size24/20240802T225030/metrics-[0-9].json',
