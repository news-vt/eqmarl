...
series=[
    dict(
        key='$\\mathtt{sCTDE}$-3',
        blob='../experiment_output/coingame_maa2c_mdp_sctde_size3/20240803T133747/metrics-[0-9].json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{sCTDE}$-6',
        blob='../experiment_output/coingame_maa2c_mdp_sctde_size6/20240802T225020/metrics-[0-9].json',
    ...
    dict(
        key='$\\mathtt{sCTDE}$-24',
        blob='../experiment_output/coingame_maa2c_mdp_sctde_size24/20240802T225027/metrics-[0-9].json',
