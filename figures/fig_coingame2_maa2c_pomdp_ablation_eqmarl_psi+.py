...
series=[
    dict(
        ...
        blob='../experiment_output/coingame_maa2c_pomdp_eqmarl_psi+_L2/20240803T190951/metrics-[0-9].json',
    ...
    dict(
        ...
        blob='../experiment_output/coingame_maa2c_pomdp_eqmarl_psi+_L10/20240803T190950/metrics-[0-9].json',
