...
series=[
    dict(
        key='$\\mathtt{fCTDE}$-3',
        blob='../experiment_output/coingame_maa2c_pomdp_fctde_size3/20240803T133747/metrics-[0-9].json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{fCTDE}$-6',
        blob='../experiment_output/coingame_maa2c_pomdp_fctde_size6/20240802T225021/metrics-[0-9].json',
        color=[0.8549019607843137, 0.5450980392156862, 0.7647058823529411],
        zorder=2,
    ),
    dict(
        key='$\\mathtt{fCTDE}$-12',
        blob='../experiment_output/coingame_maa2c_pomdp_fctde/20240501T185443/metrics-[0-9].json',
        color=[0.3333333333333333,0.6588235294117647,0.40784313725490196],
        zorder=3,
    ),
    dict(
        key='$\\mathtt{fCTDE}$-24',
        blob='../experiment_output/coingame_maa2c_pomdp_fctde_size24/20240802T225020/metrics-[0-9].json',
