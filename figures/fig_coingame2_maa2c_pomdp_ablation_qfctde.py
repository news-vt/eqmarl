...
series=[
    dict(
        key='$\\mathtt{qfCTDE}$-L2',
        blob='../experiment_output/coingame_maa2c_pomdp_qfctde_L2/20240803T191030/metrics-[0-9].json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{qfCTDE}$-L5',
    ...
    dict(
        key='$\\mathtt{qfCTDE}$-L10',
        blob='../experiment_output/coingame_maa2c_pomdp_qfctde_L10/20240803T191027/metrics-[0-9].json',
