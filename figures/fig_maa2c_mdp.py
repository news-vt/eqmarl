...
series=[
    dict(
        key='$\\mathtt{fCTDE}$',
        blob='~/Downloads/output/coingame_maa2c_classical_mdp_central/20240501T185443/metrics-[0-9].json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{qfCTDE}$',
        blob='~/Downloads/output/coingame_maa2c_quantum_mdp_central/20240503T151226/metrics-[0-9].json',
        color=[0.8549019607843137, 0.5450980392156862, 0.7647058823529411],
        zorder=2,
    ),
    dict(
        key='$\\mathtt{sCTDE}$',
        blob='~/Downloads/output/coingame_maa2c_classical_mdp/20240418T133421/metrics-[0-9].json',
