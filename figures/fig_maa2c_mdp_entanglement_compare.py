...
series=[
    ...
    dict(
        key='$\Psi^{-}$',
        blob='../experiment_output/coingame_maa2c_mdp_eqmarl_psi-/20240501T152950/metrics-[0-9].json',
        color=[0.8666666666666667, 0.5176470588235295, 0.3215686274509804],
        zorder=4,
    ),
    dict(
        key='$\Phi^{+}$',
        blob='../experiment_output/coingame_maa2c_mdp_eqmarl_phi+/20240501T152920/metrics-[0-9].json',
        color=[0.3333333333333333, 0.6588235294117647, 0.40784313725490196],
        zorder=3,
    ),
    dict(
        key='$\Phi^{-}$',
        blob='../experiment_output/coingame_maa2c_mdp_eqmarl_phi-/20240501T152925/metrics-[0-9].json',
        color=[0.7686274509803922, 0.3058823529411765, 0.3215686274509804],
        zorder=2,
    ),
    dict(
        key='$\mathtt{None}$',
        blob='../experiment_output/coingame_maa2c_mdp_eqmarl_noentanglement/20240425T114557/metrics-[0-9].json',
