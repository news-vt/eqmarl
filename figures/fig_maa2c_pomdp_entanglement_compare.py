...
series=[
    ...
    dict(
        key='$\Psi^{-}$',
        blob='~/Downloads/output/coingame_maa2c_quantum_pomdp_nnreduce_4qubits_psi-/20240502T165705/metrics-[0-9].json',
        color=[0.8666666666666667, 0.5176470588235295, 0.3215686274509804],
        zorder=4,
    ),
    dict(
        key='$\Phi^{+}$',
        blob='~/Downloads/output/coingame_maa2c_quantum_pomdp_nnreduce_4qubits/20240419T112012/metrics-[0-9].json',
        color=[0.3333333333333333, 0.6588235294117647, 0.40784313725490196],
        zorder=3,
    ),
    dict(
        key='$\Phi^{-}$',
        blob='~/Downloads/output/coingame_maa2c_quantum_pomdp_nnreduce_4qubits_phi-/20240502T165705/metrics-[0-9].json',
        color=[0.7686274509803922, 0.3058823529411765, 0.3215686274509804],
        zorder=2,
    ),
    dict(
        key='$\mathtt{None}$',
        blob='~/Downloads/output/coingame_maa2c_quantum_pomdp_nnreduce_4qubits_noentanglement/20240423T171957/metrics-[0-9].json',
