...
series=[
    dict(
        key='$\\mathtt{fCTDE}$',
        blob='../experiment_output/minigrid/minigrid-fctde-rewards.json',
        color=[0.8666666666666667,0.5176470588235295,0.3215686274509804],
        zorder=1,
    ),
    dict(
        key='$\\mathtt{qfCTDE}$',
        blob='../experiment_output/minigrid/minigrid-qfctde-rewards.json',
        color=[0.8549019607843137, 0.5450980392156862, 0.7647058823529411],
        zorder=2,
    ),
    dict(
        key='$\\mathtt{sCTDE}$',
        blob='../experiment_output/minigrid/minigrid-sctde-rewards.json',
        color=[0.3333333333333333,0.6588235294117647,0.40784313725490196],
        zorder=3,
    ),
    dict(
        key='$\\mathtt{eQMARL-}\Psi^{+}$',
        blob='../experiment_output/minigrid/minigrid-eqmarl-rewards.json',
