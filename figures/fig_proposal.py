"""Figure for quantum proposal document.

Data is taken from experiment "fig_maa2c_mdp.py" in the same directory.
"""
...
series=[
    ...
    dict(
        key='Centralized quantum RL without entanglement', # qfCTDE
    ...
    # ),
    dict(
        key='Proposed Semi-Distributed $\\mathtt{CQMARL}$ with entanglement', # eQMARL-psi+
